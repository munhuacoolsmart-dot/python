...
strDeadline = input("Please enter the date of your deadline (dd/mm/yyyy): ")

deadline = datetime.datetime.strptime(strDeadline,"%d/%m/%Y").date()
...
nbrMonths = totalNbrDays.days/30

#display the result to the user

print("You have %d weeks" %nbrWeeks + " and %d days " %nbrDays +"("+str(round(nbrMonths,0)d)+" months) until your deadline.")
